...
public ResponseEntity<?> register(@RequestBody User user)
{
	 ...
	 */
@PutMapping("/user/{id}")
public ResponseEntity<?> update(@RequestBody User user,@PathVariable("id") String id,HttpSession session)
{
...
public ResponseEntity<?> delete(@PathVariable("id") String id,HttpSession session)
{
	 ...
	 */
@GetMapping("/user/{id}")
public ResponseEntity<?> userById(@PathVariable("id") String id,HttpSession session)
{
    if(id.equals(session.getAttribute("loggedInUserId")))
    { try {  
