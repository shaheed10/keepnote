...
public class CategoryController {
    ...
    public ResponseEntity<?> create(@RequestBody Category category,HttpSession session)
    {
    ...
    {   
                if(session.getAttribute("loggedInUserId")!=null)
                    { 
                        ...
                        {
                        return new ResponseEntity<String>("Unsuccessful",HttpStatus.NOT_FOUND);
                        }
                    }
                    else{
                    return new ResponseEntity<String>("Unauthorised",HttpStatus.UNAUTHORIZED);
    ...
    public ResponseEntity<?> update(@RequestBody Category category,@PathVariable("id") int id,HttpSession session)
    {       
            if(session.getAttribute("loggedInUserId")!=null)
                    { 
                        try {
    ...
    @GetMapping("/category")
    public ResponseEntity<?> getCategoryByUserId(HttpSession session)
    {       
